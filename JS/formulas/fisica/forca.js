function calcular() {
    ...
    if (aValue.value == "" || aValue.value == 0) {
        result = (Number.parseInt(bValue.value) * Number.parseInt(cValue.value))
        aValue.value = (result)
    ...
    if (bValue.value == "" || bValue.value == 0) {
        result = (Number.parseInt(aValue.value) / Number.parseInt(cValue.value))
        bValue.value = (result)
        cValue.style.backgroundColor = 'white'
    ...
    if (cValue.value == "" || cValue.value == 0) {
        result = (Number.parseInt(aValue.value) / Number.parseInt(bValue.value))
        cValue.value = (result)
